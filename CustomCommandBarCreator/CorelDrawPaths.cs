...
namespace CustomCommandBarCreator
{
    public class CorelVersionInfo
    {
        ...
        public static readonly int MaxVersion = 27;
        ...
        private static string[] corelAbb = new string[] { "10", "11", "12", "X3", "X4", "X5", "X6", "X7", "X8", "2017", "2018", "2019", "2020", "2021", "2022", "2024","2026" };
        private string[] corelFolderList = new string[] { "Graphics10", "Corel Graphics 11", "Corel Graphics 12",
            ...
            "CorelDRAW Graphics Suite 2021","CorelDRAW Graphics Suite 2022","CorelDRAW Graphics Suite\\25","CorelDRAW Graphics Suite\\26" };
        ...
        private string[] corelDebugConst = new string[] { "", "", "", "", "", "", "", "X7", "X8", "X9", "X10", "X11", "X12", "X13", "X14", "X15","X16" };
      ...
      //  public string CorelBuildCopyCommandLabel { get { return this.corelBuildCopyCommandLabel[this.CorelVersion - 10]; } }
       ...
       // private string[] corelReferenceLabel = new string[] { "", "", "", "", "", "", "", "X7Reference", "X8Reference", "X9Reference", "X10Reference", "X11Reference", "X12Reference", "X13Reference", "X14Reference", "X15Reference", "X16Reference" };
      //  private string[] corelBuildCopyCommandLabel = new string[] { "", "", "", "", "", "", "", "X7BuildCopyCommand", "X8BuildCopyCommand", "X9BuildCopyCommand", "X10BuildCopyCommand", "X11BuildCopyCommand", "X12BuildCopyCommand", "X13BuildCopyCommand", "X14BuildCopyCommand", "X15BuildCopyCommand", "X16BuildCopyCommand" };
       // private string[] corelStartup = new string[] { "", "", "", "", "", "", "", "X7Startup", "X8Startup", "X9Startup", "X10Startup", "X11Startup", "X12Startup", "X13Startup", "X14Startup", "X15Startup", "X16Startup" };
